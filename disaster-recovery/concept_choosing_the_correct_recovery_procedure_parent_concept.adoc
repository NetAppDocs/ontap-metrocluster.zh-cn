...
* 其他硬件出现故障
 ...
 a| 
xref:task_recover_from_a_non_controller_failure_mcc_dr.adoc[从非控制器故障中恢复]
...
* 驱动器出现故障
 ...
 a| 
xref:task_recover_from_a_multi_controller_and_or_storage_failure.adoc[从多控制器或存储故障中恢复]
