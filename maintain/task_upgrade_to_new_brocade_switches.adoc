...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[完成后Brocade升级至G620]
...
----
+
image::../media/brocade_upgr_to_g620_fab_1_down.gif[Brocade升级至 G620，Fabric 1 被取消]
...
.. 在机架中安装新交换机。
+
image::../media/brocade_upgr_to_g620_replaced_a_1.gif[Brocade升级至 G620 并更换 A1]
...
+
image::../media/brocade_upgr_to_g620_replaced_b_1.gif[Brocade升级至 G620 并更换 B1]
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Brocade G620 交换机更换和升级完成后的MetroCluster工作流程]
