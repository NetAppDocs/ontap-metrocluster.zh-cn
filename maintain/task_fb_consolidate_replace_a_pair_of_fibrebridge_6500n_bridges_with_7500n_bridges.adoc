...
image::../media/consolidating_stacks_before.gif[在更换 FibreBridge 之前整合堆栈]
...
+
image::../media/consolidating_stacks_1st_7500n_in_place.gif[使用第一台 FibreBridge 7500N 整合堆栈]
...
** 此时请勿连接 FibreBridge 7600N 或 7500N 网桥 FC1 端口。image:../media/consolidating_stacks_2nd_7500n_in_place.gif["使用第二台 FibreBridge 7500N 整合堆栈"]
...
+
image::../media/consolidating_stacks_sas_top_before.gif[在布线到 FibreBridge 7500N 之前整合 SAS 堆栈]
...
+
image::../media/consolidating_stacks_sas_top_after.gif[整合后的 SAS 顶部布线]
...
+
image::../media/consolidating_stacks_sas_bottom_before.gif[整合到底层机架之前的绿色 SAS 布线]
...
+
image::../media/consolidating_stacks_sas_bottom_after.gif[整合后的 SAS 底部布线]
...
+
image::../media/consolidation_sas_bottom_connection_4_stacks.gif[四个堆栈的 SAS 底部布线]
...
image::../media/zoning_consolidation_site_a_before.gif[FibreBridge 变更之前站点 A 的分区合并]
...
image::../media/zoning_consolidation_site_a_after.gif[FibreBridge 变更后站点 A 的分区合并]
...
+
image::../media/consolidating_stacks_sas_ports_recabled.gif[合并到 FC_switch_A_2 后的 FC2 端口布线]

. 使用缆线将底部网桥的 FC1 端口连接到 FC_switch_A_1 上的正确端口。
+
image::../media/consolidating_stacks_final.gif[最终堆叠整合布线]
