...
NOTE: 随着 ONTAP 9.8 的发布， MetroCluster 升级和扩展过程已移至 link:../upgrade/index.html["MetroCluster 升级和扩展"] 和 link:../transition/index.html["从 MetroCluster FC 过渡到 MetroCluster IP"]。
