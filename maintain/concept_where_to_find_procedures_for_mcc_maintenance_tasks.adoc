...
固件升级
 a| 
link:maintain/task_upgrade_firmware_on_mcc_ip_switches.html["升级 MetroCluster IP 交换机上的固件"]
...
RCF文件升级
 a| 
link:maintain/task_upgrade_rcf_files_on_mcc_ip_switches.html["升级 MetroCluster IP 交换机上的 RCF 文件"]

link:maintain/task_upgrade_rcf_files_on_cisco_ip_switches_with_cleanupfiles.html["使用CleanUpFiles升级Cisco IP交换机上的RCF文件"]
...
重命名交换机
 a| 
link:maintain/task_rename_a_cisco_ip_switch.html["重命名 Cisco IP 交换机"]
