...
NOTE: 只能使用 CLI 配置使用 HTTPS 的 ONTAP Mediator。不支持 System Manager。有关详细信息，请参阅 link:concept_mediator_requirements.html#select-a-communication-protocol-for-ontap-mediator["选择 ONTAP Mediator 的通信协议"]。
