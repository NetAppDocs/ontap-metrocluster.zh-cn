...
* 使用单个 ONTAP Mediator 实例监控多个 MetroCluster IP 配置的支持取决于您是使用 HTTPS 还是 iSCSI 配置 ONTAP Mediator。有关详细信息，请参阅 link:concept_mediator_requirements.html#mediator-multiple-mccip["使用 ONTAP Mediator 监控多个 MetroCluster IP 配置"]。
