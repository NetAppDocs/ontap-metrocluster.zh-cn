...
如果要与非 MetroCluster 网络共享 ISL ，则必须遵循一节中的准则 xref:concept_prepare_for_the_mcc_installation.html#considerations-for-sharing-private-layer-2-networks[共享私有第 2 层网络的注意事项]。
