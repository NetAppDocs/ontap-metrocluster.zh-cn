...
xref:concept_prepare_for_the_mcc_installation.html#considerations-for-metrocluster-ip-configuration[MetroCluster IP 配置的注意事项]
...
link:concept_prepare_for_the_mcc_installation.html#considerations-for-configuring-cluster-peering["配置集群对等的注意事项"]

link:task_install_and_cable_the_mcc_components.html#cabling-the-cluster-peering-connections["为集群对等连接布线"]
