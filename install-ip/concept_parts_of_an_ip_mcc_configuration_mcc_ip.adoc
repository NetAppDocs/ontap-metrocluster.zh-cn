...
image::../media/mcc_ip_hardware_architecture_mcc_ip.gif[MetroCluster IP 硬件架构]
...
image::../media/mcc_dr_groups_4_node.gif[四节点配置中的MetroCluster DR 组]
...
image::../media/mcc_ip_hardware_architecture_ha_pairs.gif[MetroCluster IP 硬件架构 HA 对]
...
image::../media/mcc_ip_hardware_architecture_ip_interconnect.png[MetroCluster IP 硬件架构 IP 互连]
...
image::../media/mcc_ip_lif_usage.gif[MetroCluster IP LIF 使用情况]
...
image::../media/mcc_ip_hardware_architecture_cluster_peering_network.gif[MetroCluster IP 硬件架构集群对等网络]
