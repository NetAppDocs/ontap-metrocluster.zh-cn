...
image::../media/mcc-ip-cabling-a70-c80-a90-a1k-to-cisco-9336c-shared-switch-updated.png[显示了Cisco 9334C－拧动共享交换机平台的端口分配]
...
image::../media/mcc-ip-cabling-aff-a70-fas70-c80-fas90-a90-a1k-cisco-9336c-shared-switch-not-connecting-updated.png[显示了Cisco 9334C－拧动共享交换机平台的端口分配]
