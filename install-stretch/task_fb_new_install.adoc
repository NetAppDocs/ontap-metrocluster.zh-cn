...
image::../media/workflow_bridge_installation_and_configuration.gif[FC 至 SAS 桥接器安装和配置的工作流程]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[MetroCluster布线 FibreBridge 配置与多个 SAS3 堆栈]
