...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[ONTAP中的节点和集群配置工作流程图]
...
+
link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sag/home.html["使用 CLI 进行集群管理"^] 在"管理配置备份"部分下包含其他信息。
