...
下表显示了Cisco 9132T交换机上的端口使用情况。下表显示了在两个DR组中使用四个和八个控制器模块时支持的最大配置。
...
4+| 具有2个LEM和1个四节点MetroCluster或DR组的Cisco 9132T 
...
4+| 具有两个四节点MetroCluster或一个具有两个DR组的八节点MetroCluster的Cisco 9132T 
