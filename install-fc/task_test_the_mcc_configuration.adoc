...
. 关闭网桥的电源。
. 确认网桥监控指示错误： `storage bridge show`
+
[listing]
----
...
----
. 确认网桥后面的驱动器可通过单个路径使用： `storage disk error show`
+
[listing]
----
...
+
... 禁用网络结构中的第一个交换机： `sswitchDisable`
+
[listing]
----
FC_switch_A_1::> switchdisable
----
... 禁用网络结构中的第二个交换机： `sswitchable disable`
+
[listing]
----
...
+
... 重新启用网络结构中的第一个交换机： `sswitchenable`
+
[listing]
----
FC_switch_A_1::> switchenable
----
... 重新启用网络结构中的第二个交换机： `sswitchenable`
+
[listing]
----
