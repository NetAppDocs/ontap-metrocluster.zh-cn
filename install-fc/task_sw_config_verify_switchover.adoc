...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[ONTAP中的工作流高级节点和集群配置]
...
.相关信息
link:https://docs.netapp.com/us-en/ontap/high-availability/index.html["HA对管理"^]
