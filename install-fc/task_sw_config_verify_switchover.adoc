...
NOTE: 如果要使用单个镜像数据聚合，请参见 link:concept_configure_the_mcc_software_in_ontap.adocSTEP_429E7F7532ED4B468B67B9B22968D686["" 在 ONTAP 中配置 MetroCluster 软件 " 中的步骤 1"] 有关说明，请参见。
