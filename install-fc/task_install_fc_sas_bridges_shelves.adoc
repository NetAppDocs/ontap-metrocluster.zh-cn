...
== 支持的光纤桥接7600N和7500N网桥上的磁盘和磁盘架数量

下表显示了一对光纤桥7600N和7500N网桥支持的磁盘和磁盘架数量。

[NOTE]
====
* 您达到的第一个限制适用。
* 如果您使用的是DS460C磁盘架、则最多只能使用240个驱动器、即4个磁盘架。
* 如果您使用的是DS212C磁盘架、则最多只能使用120个驱动器、即10个磁盘架。


====
.支持的磁盘数
查看一对光纤桥接7600N或7500N网桥支持的磁盘数量：

[cols="3*"]
|===
| 磁盘配置 | 磁盘类型 | 每个网桥对的总磁盘数 
