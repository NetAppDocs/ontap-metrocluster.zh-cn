...
您可以从中使用 FibreBridge 6500N 网桥热插拔操作步骤 _FibreBridge 6500N 网桥并使用 FibreBridge 7500N 或 7600N 网桥 _ 更改分区或从 FibreBridge 6500 升级到 FibreBridge 7500 https://docs.netapp.com/us-en/ontap-metrocluster/maintain/index.html["《 MetroCluster 维护指南》"]。
