...
image::../media/mcc_mirroring_of_svms.gif[SVM 的MetroCluster镜像]

如果发生切换，则正常运行的集群上的远程丛会联机，并且二级 SVM 会开始提供数据。

image::../media/mcc_svms_after_switchover.gif[切换后的MetroCluster SVM]
...
image::../media/mcc_mirroring_of_pools.gif[MetroCluster存储池镜像]
...
| 在 MetroCluster 配置中 | 在非 MetroCluster HA 对中 
 ...
 a| 
image:../media/mcc_nvram_quartering.gif["MetroCluster配置中的非易失性缓存四分之一"]
 a| 
image:../media/mcc_nvram_split_in_non_mcc_ha_pair.gif["非MetroCluster HA 对中的非易失性缓存拆分"]
...
image::../media/mcc_nvram_mirroring_example.gif[MetroCluster NVRAM镜像示例]
...
image::../media/mcc_nvram_mirroring_example_dynamic_dr_aux.gif[具有 DR 辅助功能的MetroCluster NVRAM镜像]
...
image::../media/mcc_disk_ownership.gif[MetroCluster磁盘所有权]
...
image::../media/mcc_so_sb_with_autoheal.gif[MetroCluster切换和切换回自动修复]
...
image::../media/mcc_uso_with_autoheal.gif[MetroCluster具有自动修复功能的计划外切换]
