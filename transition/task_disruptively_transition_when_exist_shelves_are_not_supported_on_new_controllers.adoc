...
image::../media/workflow_2n_transition_old_shelves_not_supported.png[旧货架不受支持时的过渡工作流程]
...
image::../media/transition_2n_unsupported_old_new_shelves_to_old_controllers.png[过渡期间将新机架布线到旧控制器]
