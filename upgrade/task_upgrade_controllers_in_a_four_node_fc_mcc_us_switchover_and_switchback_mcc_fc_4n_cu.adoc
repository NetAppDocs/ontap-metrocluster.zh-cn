...
NOTE: 如果原始或新平台是使用FC-VI模式下端口1c和1d的FAS8020或AFF8020系统、请查看 link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/MetroCluster/Upgrading_controllers_when_FCVI_connections_on_existing_FAS8020_or_AFF8020_nodes_use_ports_1c_and_1d["NetApp知识库：如果现有FAS8020或AFF8020节点上的FCVI连接使用端口1c和1d、则升级控制器。"^]

* 两个站点的许可证必须匹配。您可以从获取新许可证 link:https://mysupport.netapp.com/site/["NetApp 支持站点"^]。
...
NOTE: 在 FC-VI 模式下使用 1c 和 1d 端口时，不支持升级 FAS8020 或 AFF8020 。
