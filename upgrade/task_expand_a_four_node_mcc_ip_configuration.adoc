...
下表显示了在MetroCluster IP配置中扩展AFF或FAS系统时支持的平台组合：

image::../media/mccip_expand_ip_8node_9161.png[适用于8节点配置的平台组合]
...
* 根据您的ONTAP版本、您可以在初始配置后更改某些MetroCluster IP接口属性。有关支持的功能的详细信息、请参见 link:../maintain/task-modify-ip-netmask-properties.html["修改MetroCluster IP接口的属性"] 。
