...
从ONTAP 9.13.1开始、您可以临时扩展八节点MetroCluster配置以刷新控制器和存储。请参见 link:https://docs.netapp.com/us-en/ontap-metrocluster/upgrade/task_refresh_4n_mcc_ip.html["刷新四节点或八节点MetroCluster IP配置(ONTAP 9.8及更高版本)"] 有关详细信息 ...
...
====
image::../media/8node_comb_ip_914.png[适用于8节点配置的平台组合]
