...
+
** 链接： ./install-ip/task_switch_config_Broadcom.html#reseting-the_Broadcom-ip-switch-to factory-defaults #reseting-the_Broadcom-ip-switch-to factory-defaults （将 Broadcom IP 交换机重置为出厂默认设置）
** 链接： ./install-ip/task_switch_config_Broadcom.html#reseting-the_Broadcom-ip-switch-to factory-defaults #reseting-the_cisco-ip-switch-to factory-defaults （将 Cisco IP 交换机重置为出厂默认值）
...
+
** 链接： ./install-ip/task_switch_config_Broadcom.html#reseting-the_Broadcom-ip-switch-to factory-defaults #downloading-and-installing-the_Broadcom-RCF 文件 [ 下载并安装 Broadcom RCF 文件 ]
** 链接： ./install-ip/task_switch_config_Broadcom.html#reseting-the_Broadcom-ip-switch-to factory-defaults #downloading-and-installing-the_cisco-ip-RCF files[ 下载并安装 Cisco IP RCF 文件 ]
...
Tiebreaker
 a| 
link:install-stretch/concept_considerations_when_removing_mcc_configurations.html["删除 MetroCluster 配置"] 在 _Tiebreaker MetroCluster 安装和配置内容 _ 中
...
. 从启动菜单中选择选项 `5` 以转到维护模式。按问题解答 `yes` 显示提示，直到节点在维护模式和命令提示符 * > 处停止为止。
