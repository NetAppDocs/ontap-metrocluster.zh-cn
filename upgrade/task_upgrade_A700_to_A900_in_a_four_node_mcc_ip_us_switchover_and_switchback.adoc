...
---
= 使用切换和切回功能将MetroCluster IP配置中的AFF A700/A900控制器升级到FAS9x00 (ONTAP 9.10.1或更高版本)
:allow-uri-read: 
...
AFF A700或FAS9000上的MetroCluster IP配置不使用VLAN。AFF A900或FAS9500上的MetroCluster 配置确实使用VLAN。因此、在从AFF A700或FAS9000升级到AFF A900或FAS9500时、您需要更改RCF文件。
