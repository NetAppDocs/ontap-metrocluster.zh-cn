...
* 对数据库使用加密
+
** 支持静态数据加密。link:https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals["详细了解空闲数据加密"^]
...
.下一步是什么？
link:install-choose-procedure.html["选择您的安装操作步骤"] 安装或升级 Tiebreaker。
