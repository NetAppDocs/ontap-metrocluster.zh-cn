...
[role="lead"]
在主机Linux操作系统上全新安装或升级到Tieb破碎 机1.6或Tieb破碎 机1.6P1、以监控MetroCluster配置。
...
NOTE: 安装 Tiebreaker 1.6 或更高版本后，您需要link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["导入证书"]以启用无缝监控。



== 安装或升级到Tieb破碎 机1.6P1

您可以安装Tieb破碎 机1.6P1、也可以从Tieb破碎 机1.6、1.5或1.4升级到Tieb破碎 机1.6P1。

.步骤
. 下载MetroCluster Tieb破碎 机1.6P1软件。
+
...
NOTE: 从1.6升级到Tiebre破碎 机1.6P1后、您可以删除现有的监控器、然后重新添加要监控的MetroCluster配置。
...
----
=====
.. 按照中的步骤删除并重新添加MetroCluster配置link:concept_configuring_the_tiebreaker_software.html["配置 Tiebreaker 软件"]。
...
您可以安装Tieb破碎 机1.6、也可以从Tieb破碎 机1.5或1.4升级到Tieb破碎 机1.6。
...
.下一步是什么？
成功安装或升级 Tiebreaker 后，请link:configure-tb-workflow.html["配置 MetroCluster Tiebreaker 软件"]添加MetroCluster配置并导入所需的证书。
