...
NOTE: 在 Tiebreaker 1.6 及更高版本中，您可以使用以下方式启用添加显示器时的自动切换： `monitor add wizard`命令。参考link:concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb["添加 MetroCluster 配置"]。
